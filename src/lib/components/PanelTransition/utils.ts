 ...
 */
export const createPanelStartPhaseTransitionGenerator: TransitionPhaseGenerator =
 ...
 */
export const createPanelActivePhaseTransitionGenerator: TransitionPhaseGenerator =
  (theme, phase) => ({os, transitionType}) => os === OS.IOS
